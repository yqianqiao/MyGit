package com.example.y.toutiao.util;

import android.content.SharedPreferences;
import android.graphics.Color;
import android.preference.PreferenceManager;

import com.example.y.toutiao.Constant;
import com.example.y.toutiao.InitApp;
...
public class SettingUtil {
    ...
    public boolean getIsNoPhotoMode() {
        return setting.getBoolean(Constant.SWITCH_NOPHOTOMODE, false) && NetWorkUtil.isMobileConnected(InitApp.AppContext);
    }
    ...
    public int getColor() {
        ...
        int color = setting.getInt(Constant.COLOR, defaultColor);
    ...
    public void setColor(int color) {
        setting.edit().putInt(Constant.COLOR, color).apply();
    }
    ...
    public boolean getIsNightMode() {
        return setting.getBoolean(Constant.SWITCH_NIGHTMODE, false);
    }
    ...
    public void setIsNightMode(boolean flag) {
        setting.edit().putBoolean(Constant.SWITCH_NIGHTMODE, flag).apply();
    }
    ...
    public boolean getIsAutoNightMode() {
        return setting.getBoolean(Constant.AUTO_NIGHTMODE, false);
    }
    ...
    public void setIsAutoNightMode(boolean flag) {
        setting.edit().putBoolean(Constant.AUTO_NIGHTMODE, flag).apply();
    }
    ...
    public boolean getIsVideoAutoPlay() {
        return setting.getBoolean("video_auto_play", false) && NetWorkUtil.isFifiConnected(InitApp.AppContext);
    }
